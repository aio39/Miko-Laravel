    ...
    public function run()
    {
        ...
        DB::table('concerts')->insert([
            ...
            [
                ...
                'category_id' => 4,
                'user_id' => 2,
                'cover_image' => 'cover_image/mhaLive.jpg',
                'title' => "mhaLive",
                'artist' => "mha",
                'detail' => $detail,
                'content' => $longContext,
                'all_concert_start_date' => "2022-4-17 07:00:00",
                'all_concert_end_date' => "2022-10-17 08:00:00",
                'sales_volume' => 0,
            ],
            [
                ...
                'category_id' => 4,
                'user_id' => 2,
                'cover_image' => 'cover_image/Namida.jpg',
                'title' => "Namida Live Concert",
                'artist' => "Namida",
                'detail' => $detail,
                'content' => $longContext,
                'all_concert_start_date' => "2022-4-17 07:00:00",
                ...
                'category_id' => 3,
                'user_id' => 2,
                'cover_image' => 'cover_image/next_natsumeeri-1.jpg',
                'title' => "Natsumeeri Live Concert",
                'artist' => "natsumeeri",
                'detail' => $detail,
                'content' => $longContext,
                'all_concert_start_date' => "2022-4-17 07:00:00",
            ...
            [
                ...
                'category_id' => 4,
                'user_id' => 2,
                'cover_image' => 'cover_image/rockConcert.jpg',
                ...
                'category_id' => 6,
                'user_id' => 1,
                'cover_image' => 'cover_image/woogon.jpeg.jpeg',
                'title' => "WOOGON Concert",
                'artist' => "WOOGON Solo LIVE-MAZE-オンライン生配信",
                'detail' => $detail,
                'content' => $longContext,
                'all_concert_start_date' => "2022-4-17 07:00:00",
                'all_concert_end_date' => "2022-10-17 08:00:00",
                ...
                'category_id' => 6,
                'user_id' => 1,
                'cover_image' => 'cover_image/sol.jpeg',
                'title' => "Sol Concert",
                'artist' => "Sol Special LIVE「ただいま」オンライン生配信",
                'detail' => $detail,
                'content' => $longContext,
                'all_concert_start_date' => "2022-4-17 07:00:00",
                'all_concert_end_date' => "2022-10-17 08:00:00",
                ...
                'category_id' => 6,
                'user_id' => 1,
                'cover_image' => 'cover_image/girl.jpeg',
                'title' => "安斉かれん",
                'artist' => "First Online Live「ちゃんと世界線」",
                'detail' => $detail,
                'content' => $longContext,
                'all_concert_start_date' => "2022-4-17 07:00:00",
                'all_concert_end_date' => "2022-10-17 08:00:00",
                ...
                'category_id' => 6,
                'user_id' => 1,
                'cover_image' => 'cover_image/girls.jpeg',
                'title' => "新田恵海、飯田里穂、徳井青空、佐々木未来",
                'artist' => "歌う！声優女子４人LIVE ゆるシェアルームへようこそ！",
                'detail' => $detail,
                'content' => $longContext,
                'all_concert_start_date' => "2022-4-17 07:00:00",
                'all_concert_end_date' => "2022-10-17 08:00:00",
                ...
                'category_id' => 5,
                'user_id' => 1,
                'cover_image' => 'cover_image/tritops.jpeg',
                'title' => "TRITOPS",
                'artist' => "Special live -Celebration-",
                'detail' => $detail,
                'content' => $longContext,
                'all_concert_start_date' => "2022-4-17 07:00:00",
                'all_concert_end_date' => "2022-10-17 08:00:00",
            ...
            [
                ...
                'category_id' => 2,
                'user_id' => 2,
                'cover_image' => 'cover_image/blackpink.jpg',
                'title' => "夢のblackpinkコンサート",
                'artist' => "Blackpink",
                'detail' => $detail,
                'content' => $longContext,
                'all_concert_start_date' => "2022-10-17 07:00:00",
                ...
                'category_id' => 2,
                'user_id' => 2,
                'cover_image' => 'cover_image/mnl48.jpg',
                'title' => "MNL48 コンサート",
                'artist' => "MNL48",
                'detail' => $detail,
                'content' => $longContext,
