    ...
    public function run()
    {
        DB::table('products')->insert([
            ...
            [
                ...
                'image' => "product_image/ecoBag.jpeg"
            ],[
                'created_at' => now(),
                'updated_at' => now(),
                'concert_id' => 1,
                ...
                'image' => "product_image/tshirt.jpeg"
            ],[
                'created_at' => now(),
                'updated_at' => now(),
                'concert_id' => 1,
                ...
                'image' => "product_image/stick.jpeg"
            ],[
                'created_at' => now(),
                'updated_at' => now(),
                'concert_id' => 2,
                ...
                'image' => "product_image/rebecaProduct.png"
            ],[
                'created_at' => now(),
                'updated_at' => now(),
                'concert_id' => 3,
                ...
                'image' => "product_image/fripSide.jpeg"
            ]
        ]);
    }
}
