    ...
    public function run()
    {
        DB::table('products')->insert([
            ...
            [
                ...
                'concert_id' => 1,
                'price' => '3980',
                'name' => "【 ショッピングバッグ 】 Feel da CITY 2022 公式グッズ",
                'color' => json_encode(['Black' ,'Blue', 'Red', 'White', 'Yellow']),
                'size' => json_encode(['S' ,'M', 'L']),
                'stock'=>7,
                ...
                'concert_id' => 2,
                'price' => '4460',
                'name' => "ミュージカル レベッカ OST リパッケージ (Das Musical Rebecca Repackage Album 2017)",
                'color' => json_encode(['Black' ,'Blue', 'Red', 'White', 'Yellow']),
                'size' => json_encode(['S' ,'M', 'L']),
                'stock'=>7,
